...
public class GamesLibraryTest {
  ...
  public void test_addGameInvalidPlatform(){
    ...
    var okami = new Game("Okami", Genre.ADVENTURE, ps2, 2006, 93);
  ...
  public void test_getGamesReadonly(){
    var games = lib.getGamesReadOnly();

    assertNotNull(games);

    var gamesSorted = new TreeSet<Game>();
  ...
  public void test_getBestGame(){
    ...
    var okami = new Game("Okami", Genre.ACTION, ns, 2018, 100 );
    lib.addGame(okami);
  ...
  public void test_getGenreCount(){
    var genreCount = lib.getGenreCount();
  ...
  public void test_getGamesForPlatform(){
    var gamesForPlatform = lib.getGamesForPlatform();
  ...
  public void test_getAverageScoreForPlatform(){
    ...
    var scoreForPlatform = lib.getAverageScoreForPlatform();
  ...
  public void test_sortGamesByMetacriticScore(){
    var top = lib.sortGamesByMetacriticScore();
