...
public class GameTest {
  ...
  public void test_constructor(){
    var celeste = new Game("Celeste", Genre.PLATFORMER, ns, 2018, 92);
  ...
  public void test_compareToCorrectness(){
    ...
    var other = new Game("Celeste", Genre.PLATFORMER, ns, 2018, 92);
...
other = new Game("Deleste", Genre.PLATFORMER, ns, 2019, 92);
  ...
  public void test_compareToEqualsConsistency(){
    var celeste = new Game("Celeste", Genre.PLATFORMER, ns, 2018, 92);
    var other1 = new Game("Celeste", Genre.PLATFORMER, ns, 2018, 92);
    var other2 = new Game("Deleste", Genre.PLATFORMER, ns, 2018, 92);
    var other3 = new Game("Celeste", Genre.SHOOTER, ns, 2018, 92);
    var other4 = new Game("Celeste", Genre.PLATFORMER, xboxOne, 2018, 92);
    var other5 = new Game("Celeste", Genre.PLATFORMER, ns, 2019, 92);
    var other6 = new Game("Celeste", Genre.PLATFORMER, ns, 2019, 93);
